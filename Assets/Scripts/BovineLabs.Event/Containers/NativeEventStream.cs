...
namespace BovineLabs.Event.Containers
{
    ...
    public unsafe partial struct NativeEventStream : IDisposable, IEquatable<NativeEventStream>
    {
        ...
        private UnsafeEventStream _stream;
        ...
        public NativeEventStream(Allocator allocator)
        {
            ...
            this._stream.AllocateForEach(JobsUtility.MaxJobThreadCount);
        }
        ...
        public NativeEventStream(int foreachCount, Allocator allocator)
        {
            ...
            this._stream.AllocateForEach(foreachCount);
        }
        ...
        /// </remarks>
        public bool IsCreated => this._stream.IsCreated;

        /// <summary> Gets the number of streams the container can use. </summary>
        public int ForEachCount => this._stream.ForEachCount;

        public bool IsEmpty()
        {
            return this._stream.IsEmpty();
        }
        ...
        {
            this.CheckReadAccess();
            return this._stream.ToNativeArray<T>(allocator);
        }
        ...
        {
            return this._stream.Equals(other._stream);
        }
