...
namespace BovineLabs.Event.Containers
{
    ...
    public unsafe partial struct UnsafeEventStream : INativeDisposable, IEquatable<UnsafeEventStream>
    {
        ...
        private UnsafeEventStreamBlockData* _blockData;
        ...
        /// </remarks>
        public bool IsCreated => this._blockData != null;

        /// <summary> Gets the number of streams the list can use. </summary>
        public int ForEachCount => _blockData->RangeCount;
        ...
        public bool IsEmpty()
        {
            ...
            for (int i = 0; i != _blockData->RangeCount; i++)
            {
        ...
        {
            return this._blockData == other._blockData;
        }
        ...
        internal void AllocateForEach(int forEachCount)
        {
            ...
            _blockData->Ranges = (UnsafeEventStreamRange*)UnsafeUtility.Malloc(allocationSize, 16, this._allocator);
            _blockData->ThreadRanges = (UnsafeEventStreamThreadRange*)UnsafeUtility.Malloc(allocationThreadSize, 16, this._allocator); // todo conditional
            _blockData->RangeCount = forEachCount;
