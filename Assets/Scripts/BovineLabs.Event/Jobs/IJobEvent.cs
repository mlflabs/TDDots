...
namespace BovineLabs.Event.Jobs
{
    ...
    public static class JobEvent
    {
            ...
            where T : struct
        {
            ...
            private static IntPtr _jobReflectionDataSingle;

            // ReSharper disable once StaticMemberInGenericType
            private static IntPtr _jobReflectionDataParallel;
            ...
            {
                if (_jobReflectionDataSingle == IntPtr.Zero)
                {
#if UNITY_2020_2_OR_NEWER
                    _jobReflectionDataSingle = JobsUtility.CreateJobReflectionData(
                ...
                return _jobReflectionDataSingle;
            }
            ...
            {
                if (_jobReflectionDataParallel == IntPtr.Zero)
                {
#if UNITY_2020_2_OR_NEWER
                    _jobReflectionDataParallel = JobsUtility.CreateJobReflectionData(
                        typeof(JobEventProducer<TJob, T>),
                        typeof(TJob),
                        (ExecuteJobFunction)Execute);
#else
                ...
                return _jobReflectionDataParallel;
            }
