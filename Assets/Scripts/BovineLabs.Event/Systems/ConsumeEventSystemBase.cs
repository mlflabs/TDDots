...
namespace BovineLabs.Event.Systems
{
        ...
        where T : struct
    {
        ...
        {
            this._eventSystem = this.World.GetOrCreateSystem<EventSystem>();
        ...
        protected sealed override void OnUpdate()
        {
            ...
            if (!this._eventSystem.HasEventReaders<T>())
            {
                return;
            }

            this.Dependency = this._eventSystem.GetEventReaders<T>(this.Dependency, out IReadOnlyList<NativeEventStream.Reader> readers);
            ...
            {
                this._eventSystem.AddJobHandleForConsumer<T>(this.Dependency);
            }
        }
